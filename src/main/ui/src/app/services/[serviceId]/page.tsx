...
export default function ServiceId() {
  ...
  const onSubmit = async () => {
    ...
    try{
      ...
      const newData = await patchFetcher(rentSystemPaths.services.edit(serviceId),obj);
      toast({
      ...
      toast({
        ...
        variant: "destructive",
        description: "Hubo un problema al tratar de modificar el servicio. Intento luego o consulte a un administrador."
      })
    }
  }
  ...
  return (
    <main className="min-h-screen">
      <Title title={data.value.name} backgroundImage={rentSystemImages.service} />
